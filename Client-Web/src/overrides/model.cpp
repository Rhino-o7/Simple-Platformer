...
#include "../../../CoreLib/src/data/model.hpp"
#include "../../../CoreLib/src/data/qb_parser.hpp"
#include "../../../CoreLib/src/config.hpp"
...
void* vpg::data::Model::load(Asset* asset) {
    ...
    if (!gl::VertexArray::create(model->va, {
        gl::Attribute(
            model->vb,
            sizeof(gl::Vertex), offsetof(gl::Vertex, pos),
            3, gl::Attribute::Type::F32,
            0
        ),
        gl::Attribute(
            model->vb,
            sizeof(gl::Vertex), offsetof(gl::Vertex, normal),
            3, gl::Attribute::Type::F32,
            1
        ),
        gl::Attribute(
            model->vb,
            sizeof(gl::Vertex), offsetof(gl::Vertex, material),
