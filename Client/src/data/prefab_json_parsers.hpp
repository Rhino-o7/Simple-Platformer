...
namespace game::prefab_json_parsers {
    using JsonValue = game::prefab_json_registry::JsonValue;
    using EntityLookup = game::prefab_json_registry::EntityLookup;
    using PendingParents = game::prefab_json_registry::PendingParents;
    ...
    namespace detail {
        ...
        inline bool as_quat(const JsonValue* value, glm::quat& out) {
            return game::json_utils::as_quat_xyzw(value, out);
        }

        inline bool resolve_entity_ref(const EntityLookup& entities, const std::string& name, vpg::ecs::Entity& out_ref, std::string& error) {
        ...
        inline bool parse_platform_behaviour(vpg::ecs::Entity entity, const JsonValue& behaviour, const EntityLookup&, std::string& error) {
            Platform::Info info = {};
        ...
        inline bool parse_turret_behaviour(vpg::ecs::Entity entity, const JsonValue& behaviour, const EntityLookup&, std::string& error) {
            Turret::Info info = {};
        ...
        inline bool parse_firetrap_behaviour(vpg::ecs::Entity entity, const JsonValue& behaviour, const EntityLookup&, std::string& error) {
            Firetrap::Info info = {};
        ...
        inline bool parse_firespread_behaviour(vpg::ecs::Entity entity, const JsonValue& behaviour, const EntityLookup&, std::string& error) {
        ...
        inline bool parse_smoke_behaviour(vpg::ecs::Entity entity, const JsonValue& behaviour, const EntityLookup&, std::string& error) {
            Smoke::Info info = {};
        ...
        inline bool parse_bullet_behaviour(vpg::ecs::Entity entity, const JsonValue&, const EntityLookup&, std::string&) {
            Bullet::Info info = {};
            vpg::ecs::add_component<vpg::ecs::Behaviour>(entity, vpg::ecs::Behaviour::Info::create<Bullet>(std::move(info)));
            return true;
        }

        inline bool parse_player_controller_behaviour(vpg::ecs::Entity entity, const JsonValue& behaviour, const EntityLookup& entities, std::string& error) {
        ...
        inline bool parse_player_instance_behaviour(vpg::ecs::Entity entity, const JsonValue& behaviour, const EntityLookup& entities, std::string& error) {
        ...
        inline bool parse_map_controller_behaviour(vpg::ecs::Entity entity, const JsonValue& behaviour, const EntityLookup& entities, std::string& error) {
        ...
        inline bool parse_behaviour(vpg::ecs::Entity entity, const JsonValue& behaviour, const EntityLookup& entities, std::string& error) {
            std::string type;
            ...
            auto parser = game::prefab_json_registry::find_behaviour_parser(type);
            if (parser == nullptr) {
                error = "Unsupported behaviour type '" + type + "'";
                return false;
            }

            return parser(entity, behaviour, entities, error);
        }

        inline bool parse_transform_component(vpg::ecs::Entity entity, const JsonValue& transform, const EntityLookup&, PendingParents& pending_parents, std::string& error) {
        ...
        inline bool parse_collider_component(vpg::ecs::Entity entity, const JsonValue& collider, const EntityLookup&, PendingParents&, std::string& error) {
        ...
        inline bool parse_renderable_component(vpg::ecs::Entity entity, const JsonValue& renderable, const EntityLookup&, PendingParents&, std::string& error) {
        ...
        inline bool parse_light_component(vpg::ecs::Entity entity, const JsonValue& light, const EntityLookup&, PendingParents&, std::string& error) {
            if (!light.IsObject()) {
        ...
        inline bool parse_camera_component(vpg::ecs::Entity entity, const JsonValue& camera, const EntityLookup&, PendingParents&, std::string& error) {
            if (!camera.IsObject()) {
        ...
        inline bool parse_behaviour_component(vpg::ecs::Entity entity, const JsonValue& behaviour, const EntityLookup& entities, PendingParents&, std::string& error) {
    ...
    inline void register_default_parsers() {
        static const bool registered = []() {
            // Add new behaviour parsers here (single line per behaviour type).
            game::prefab_json_registry::register_behaviour_parser(Platform::TypeName, detail::parse_platform_behaviour);
            game::prefab_json_registry::register_behaviour_parser(Turret::TypeName, detail::parse_turret_behaviour);
            game::prefab_json_registry::register_behaviour_parser(Firetrap::TypeName, detail::parse_firetrap_behaviour);
            game::prefab_json_registry::register_behaviour_parser(Firespread::TypeName, detail::parse_firespread_behaviour);
            game::prefab_json_registry::register_behaviour_parser(Smoke::TypeName, detail::parse_smoke_behaviour);
            game::prefab_json_registry::register_behaviour_parser(Bullet::TypeName, detail::parse_bullet_behaviour);
            game::prefab_json_registry::register_behaviour_parser(PlayerController::TypeName, detail::parse_player_controller_behaviour);
            game::prefab_json_registry::register_behaviour_parser(PlayerInstance::TypeName, detail::parse_player_instance_behaviour);
            game::prefab_json_registry::register_behaviour_parser(MapController::TypeName, detail::parse_map_controller_behaviour);

            // Add new component parsers here (single line per JSON component key).
            game::prefab_json_registry::register_component_parser("transform", detail::parse_transform_component);
            game::prefab_json_registry::register_component_parser("collider", detail::parse_collider_component);
            game::prefab_json_registry::register_component_parser("renderable", detail::parse_renderable_component);
            game::prefab_json_registry::register_component_parser("light", detail::parse_light_component);
            game::prefab_json_registry::register_component_parser("camera", detail::parse_camera_component);
            game::prefab_json_registry::register_component_parser("behaviour", detail::parse_behaviour_component);
            return true;
        }();
