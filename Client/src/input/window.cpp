...
bool Window::init() {
    ...
    Window::handle = glfwCreateWindow(
        fullscreen ? mode->width : Config::get_integer("window.width", 800),
        fullscreen ? mode->height : Config::get_integer("window.height", 600),
        Config::get_string("window.title", "Voxel Platformer Game").c_str(),
